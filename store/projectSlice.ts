...
const initialState: ProjectState = {
  value: [
    ...
    },
    {
      ...
      category: "WEB DEVELOPMENT",
      imgList: [
        `${process.env.BASEURL}/images/project/travel-booking/travel-booking-1.webp`,
        `${process.env.BASEURL}/images/project/travel-booking/travel-booking-2.webp`,
        `${process.env.BASEURL}/images/project/travel-booking/travel-booking-3.webp`,
        `${process.env.BASEURL}/images/project/travel-booking/travel-booking-4.webp`,
      ],
      link: `${process.env.BASEURL}/project/travel-booking`,
      extLink: "https://do1fendi.github.io/siloah-travel-booking/?selectedGroupNumber=DDT000001",
      tech: "#vuejs #nuxtjs #filemaker",
    },
    {
      id: "damarane",
      title: "植物新藥產品介紹",
    ...
    },
    {
      ...
      category: "UI DESIGN",
      imgList: [
        `${process.env.BASEURL}/images/project/micro-credit/micro-credit-1.webp`,
        `${process.env.BASEURL}/images/project/micro-credit/micro-credit-2.png`,
        `${process.env.BASEURL}/images/project/micro-credit/micro-credit-3.png`,
        `${process.env.BASEURL}/images/project/micro-credit/micro-credit-4.png`,
        `${process.env.BASEURL}/images/project/micro-credit/micro-credit-5.png`,
      ],
      link: `${process.env.BASEURL}/project/micro-credit`,
      extLink: "",
      tech: "",
    },
